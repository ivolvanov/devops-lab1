...
class Student(Model):
    ...
    """
    def __init__(self, student_id: int=None, first_name: str=None, last_name: str=None, grade_records: List[int]=None):  # noqa: E501
    ...
    @property
    def grade_records(self) -> List[int]:
    ...
    def grade_records(self, grade_records: List[int]):
